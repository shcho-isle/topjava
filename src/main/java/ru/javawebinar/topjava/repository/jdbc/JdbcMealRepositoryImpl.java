...
public class JdbcMealRepositoryImpl implements MealRepository {
    ...
    public Meal save(Meal meal, int userId) {
        ...
        if (meal.isNew()) {
            ...
            int number = namedParameterJdbcTemplate.update(
    ...
    public Meal get(int id, int userId) {
        ...
        return users.isEmpty() ? null: DataAccessUtils.singleResult(users);
    }
    ...
    public List<Meal> getBetween(LocalDateTime startDate, LocalDateTime endDate, int userId) {
        return jdbcTemplate.query("SELECT * FROM meals WHERE user_id=? AND date_time>=? AND meals.date_time<=? ORDER BY date_time DESC "
